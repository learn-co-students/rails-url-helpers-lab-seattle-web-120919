...
- A user should be able to go to `/students/:id/activate` to toggle their `active` attribute between `true` and `false`. (This is just the activate route, and not an actual view.)
